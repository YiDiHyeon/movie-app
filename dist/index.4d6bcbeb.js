...
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
var _newEasyPng = require("../common/new-easy.png");
var _newEasyPngDefault = parcelHelpers.interopDefault(_newEasyPng);
class TheHeader extends (0, _heropy.Component) {
    ...
    render() {
        this.el.innerHTML = `
            ...
            <a href="#/about" class="user"><img src="${0, _newEasyPngDefault.default}" alt="Profile image"></a>
        `;
    }
}
exports.default = TheHeader;

},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../common/new-easy.png":"7MWT1"}],"7MWT1":[function(require,module,exports) {
module.exports = require("d4be6cd05f4fbef9").getBundleURL("gnRNX") + "new-easy.145871da.png" + "?" + Date.now();

},{"d4be6cd05f4fbef9":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"b3x3c":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
...
exports.default = new (0, _heropy.Store)({
    photo: (0, _newEasyPngDefault.default),
    name: "YiDiHyeon / 이지현",
...
},{"../core/heropy":"57bZf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../common/new-easy.png":"7MWT1"}],"3L9mC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _heropy = require("../core/heropy");
...
const searchMovies = async (page)=>{
    ...
    try {
        const res = await fetch(`https://omdbapi.com?apikey=d0b745a1&s=${store.state.searchText}&page=${page}`);
...
const getMovieDetails = async (id)=>{
    try {
        const res = await fetch(`https://omdbapi.com?apikey=d0b745a1&i=${id}&plot=full`);
